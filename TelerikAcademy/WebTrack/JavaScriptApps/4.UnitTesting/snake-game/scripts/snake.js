...
var snakeGame = (function() {
  ...
  var SnakeGame = Class.create({
    ...
    initGameObjects: function() {
      ...
      // Task 3: Moved the call to attachHandlers here and created a check for the addition of keydown handlers.
      this.attachHandlers();
    },
    ...
    // Task 4: Checking whether the snake has bitten any of its pieces.
