<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="ChatSystemWeb.Account.Register" %>
...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <fieldset class="form-horizontal">
        ...
        <div class="control-group">
            <asp:Label runat="server" AssociatedControlID="Mail" CssClass="control-label">E-mail</asp:Label>
            <div class="controls">
                <asp:TextBox runat="server" ID="Mail" />
                <asp:RequiredFieldValidator runat="server" ControlToValidate="Mail"
                    CssClass="text-error" ErrorMessage="The e-mail field is required." />
            </div>
        </div>
        <div class="control-group">
