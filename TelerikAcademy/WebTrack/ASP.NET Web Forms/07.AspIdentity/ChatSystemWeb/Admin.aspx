<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="ChatSystemWeb.Admin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:GridView runat="server" ID="MessagesGrid" CurrentSortDirAuthor="ASC" CurrentSortDirText="ASC"
        ...
        OnRowEditing="MessagesGrid_RowEditing" OnRowUpdating="MessagesGrid_RowUpdating" 
        OnRowCancelingEdit="MessagesGrid_RowCancelingEdit" OnRowDeleting="MessagesGrid_RowDeleting"
        
        OnSorting="MessagesGrid_Sorting">
        <Columns>
            <asp:CommandField ShowEditButton="true" ShowDeleteButton="true" HeaderText="Manage Messages" />
            <asp:TemplateField HeaderText="Author" SortExpression="Author">
                <ItemTemplate>
                    <asp:TextBox ID="AuthorViewContent" IdAttribute='<%# Eval("Id") %>' runat="server" Text='<%# Eval("Author") %>' Enabled="false"/>
                </ItemTemplate>
                <EditItemTemplate>
