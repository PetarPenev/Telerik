<%@ Page Language="C#" AutoEventWireup="true" 
    CodeBehind="Register.aspx.cs" Inherits="_01.BasicRegisterValidation.Register" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Basic Register Validation</title>
</head>
<body>
    <form id="RegistrationForm" runat="server">
        ...
        <asp:TextBox runat="server" ID="PasswordInput" TextMode="Password" MaxLength="20"></asp:TextBox>
        <asp:RequiredFieldValidator
        ...
        <asp:TextBox runat="server" ID="RepeatPasswordInput" TextMode="Password"></asp:TextBox>
        <asp:RequiredFieldValidator
         ...
         <asp:CompareValidator ID="CompareValidatorPassword" runat="server"
            ...
            ErrorMessage="Passwords don't match!" ForeColor="Red" EnableClientScript="True" 
        ...
        <asp:TextBox runat="server" ID="AgeInput" TextMode="Number"></asp:TextBox>
        <asp:RequiredFieldValidator
        ...
        <asp:TextBox runat="server" ID="EmailInput" TextMode="Email"></asp:TextBox>
        <asp:RequiredFieldValidator
        ...
        <asp:TextBox runat="server" ID="AddressInput"></asp:TextBox>
        <asp:RequiredFieldValidator
        ...
        <asp:TextBox runat="server" ID="PhoneInput" TextMode="Phone"></asp:TextBox>
        <asp:RequiredFieldValidator
        ...
        <asp:CheckBox runat="server" ID="AcceptInput" Text="I Accept the Terms and Conditions" />
        <asp:CustomValidator 
        ...
        <asp:Button runat="server" ID="SubmitButton" Text="Register" OnClick="SubmitButton_Click" />
        <br />
