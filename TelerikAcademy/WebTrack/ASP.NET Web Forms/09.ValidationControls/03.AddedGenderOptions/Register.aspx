<%@ Page Language="C#" AutoEventWireup="true" 
    ...
    Inherits="_03.AddedGenderOptions.Register" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Registration with added gender options</title>
</head>
<body>
    <form id="RegistrationForm" runat="server">
        ...
        <asp:Panel ID="PersonalInfoPanel" runat="server" GroupingText="Personal Info">
            ...
            <asp:RangeValidator ValidationGroup="PersonalInfo"
                ...
                MinimumValue="18"
                MaximumValue="81" ForeColor="Red" Display="Dynamic"
                Type="Integer"
            ...
            <asp:RadioButtonList runat="server" ID="GenderSelector" 
                OnSelectedIndexChanged="GenderSelector_SelectedIndexChanged" AutoPostBack="true">
                <asp:ListItem Value="Male" Text="Male"></asp:ListItem>
                <asp:ListItem Value="Female" Text="Female"></asp:ListItem>
            </asp:RadioButtonList>
            <asp:CustomValidator runat="server" ID="GenderSelectorValidator" ValidationGroup="PersonalInfo"
                ErrorMessage="Gender selection is required" ForeColor="Red" Display="Dynamic"
                OnServerValidate="GenderSelectorValidator_ServerValidate">
            </asp:CustomValidator>

            <asp:Label runat="server" ID="CarListLabel" Visible="false" 
                Text="Favourite Cars:" AssociatedControlID="CarList"></asp:Label>
            <asp:CheckBoxList ID="CarList" runat="server" Visible="false" OnLoad="CarList_Load" >
            ...
            <asp:Label runat="server" ID="CoffeeListLabel" Visible="false" Text="Favourite Coffee:" 
                AssociatedControlID="CoffeeList"></asp:Label>
            <asp:DropDownList runat="server" ID="CoffeeList" Visible="false" OnLoad="CoffeeList_Load">
