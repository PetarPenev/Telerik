...
SELECT isNull(FirstName, '') + ' ' +isNull(MiddleName, '') + ' ' + isNull(LastName, '') AS [Full Name], Salary 
FROM Employees

--7. Write a SQL to find the full name of each employee.
SELECT isNull(FirstName, '') + ' ' +isNull(MiddleName, '') + ' ' + isNull(LastName, '') AS [Full Name] 
FROM Employees
...
--First solution.
SELECT e.FirstName + ' ' + e.LastName AS EmployeeName, a.AddressText AS EmployeeAddress, m.FirstName + ' ' + m.LastName AS ManagerName
...
WHERE HireDate BETWEEN '1995/01/01' AND '2005/12/25'
