...
namespace _01.DatabaseContext
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual ObjectResult<Nullable<double>> usp_FindTotalIncome(Nullable<int> supplierId, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<double>>("usp_FindTotalIncome", supplierIdParameter, startDateParameter, endDateParameter);
        }
    
        public virtual ObjectResult<Nullable<double>> GetSupplierIncome(Nullable<int> supplierId, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            var supplierIdParameter = supplierId.HasValue ?
                new ObjectParameter("supplierId", supplierId) :
                new ObjectParameter("supplierId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<double>>("GetSupplierIncome", supplierIdParameter, startDateParameter, endDateParameter);
        }
    }
}
